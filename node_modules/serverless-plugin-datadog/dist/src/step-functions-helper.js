...
exports.inspectAndRecommendStepFunctionsInstrumentation = exports.updateDefinitionForStepFunctionInvocationStep = exports.updateDefinitionString = exports.isStepFunctionInvocation = exports.isLambdaApiStep = void 0;
function isLambdaApiStep(resource) {
    // Allow for either the standard or legacy definitions of a lambda step
    return (resource !== undefined &&
        ((resource === null || resource === void 0 ? void 0 : resource.startsWith("arn:aws:states:::lambda:invoke")) || (resource === null || resource === void 0 ? void 0 : resource.startsWith("arn:aws:lambda"))));
}
exports.isLambdaApiStep = isLambdaApiStep;
function isStepFunctionInvocation(resource) {
    if (resource === undefined) {
        return false;
    }
    return resource.startsWith("arn:aws:states:::states:startExecution");
}
exports.isStepFunctionInvocation = isStepFunctionInvocation;
function parseDefinitionObject(definitionString) {
...
function updateDefinitionString(definitionString, serverless, stateMachineName) {
    ...
    for (const [stepName, step] of Object.entries(states)) {
        ...
        if (isLambdaApiStep(step === null || step === void 0 ? void 0 : step.Resource)) {
...
function inspectAndRecommendStepFunctionsInstrumentation(serverless) {
    ...
    if (stepFunctions.length !== 0) {
        serverless.cli.log(`Uninstrumented Step Functions detected in your serverless.yml file. If you would like to see Step Functions traces, please see details of 'enableStepFunctionsTracing' and 'mergeStepFunctionAndLambdaTraces' variables in the README (https://github.com/DataDog/serverless-plugin-datadog/)`);
    }
}
exports.inspectAndRecommendStepFunctionsInstrumentation = inspectAndRecommendStepFunctionsInstrumentation;
