import { BaseResult, BasicAuthCredentials, BrowserServerResult, CookiesObject, ExecutionRule, LocalTriggerConfig, MobileTestWithOverride, Result, ResultInBatch, ResultInBatchSkippedBySelectiveRerun, RetryConfig, ServerConfigOverride, ServerResult, Test, TestNotFound, TestPayload, TestSkipped, TestWithOverride, TriggerConfig, UserConfigOverride } from '../interfaces';
...
export declare const isMobileTestWithOverride: (item: TestNotFound | TestSkipped | TestWithOverride) => item is MobileTestWithOverride;
