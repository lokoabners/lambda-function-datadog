...
const runTests = (api, testsToTrigger, selectiveRerun, batchTimeout = exports.DEFAULT_BATCH_TIMEOUT) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const payload = {
...
const waitForResults = (api, trigger, tests, options, reporter, tunnel) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    reporter.testsWait(tests, (0, public_1.getAppBaseURL)(options), trigger.batch_id);
    ...
    const results = yield waitForBatchToFinish(api, trigger.batch_id, options.batchTimeout, resultDisplayInfo, reporter);
