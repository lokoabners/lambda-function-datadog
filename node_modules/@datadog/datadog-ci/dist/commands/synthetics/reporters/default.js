...
const renderStep = (step) => {
    ...
    const error = step.failure ? `\n    ${chalk_1.default.red.dim(step.failure.message)}` : '';
...
const renderApiRequestDescription = (subType, config) => {
    ...
    if (subType === 'dns') {
        if (!(request === null || request === void 0 ? void 0 : request.host)) {
    ...
    if (subType === 'ssl' || subType === 'tcp') {
        if (!(request === null || request === void 0 ? void 0 : request.host) || !(request === null || request === void 0 ? void 0 : request.port)) {
    ...
    if (subType === 'http') {
        if (!(request === null || request === void 0 ? void 0 : request.method) || !(request === null || request === void 0 ? void 0 : request.url)) {
...
const getResultIdentificationSuffix = (execution, setColor) => {
    if ((0, internal_1.isBaseResult)(execution)) {
        ...
        const device = result && (0, public_1.isDeviceIdSet)(execution) ? ` - ${setColor(`device: ${chalk_1.default.bold(execution.device.id)}`)}` : '';
