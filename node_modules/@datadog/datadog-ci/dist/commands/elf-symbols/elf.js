...
const copyElfDebugInfo = (filename, outputFile, elfFileMetadata, compressDebugSections) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (keepDynamicSymbolTable) {
        ...
        yield (0, utils_1.execute)(`objcopy ${bfdTargetOption} --dump-section .dynsym=${outputFile}.dynsym --dump-section .dynstr=${outputFile}.dynstr ${filename} ${outputFile}`);
    ...
    yield (0, utils_1.execute)(`objcopy ${options} ${filename} ${outputFile}`).finally(() => {
        if (keepDynamicSymbolTable) {
            fs_1.default.unlinkSync(`${outputFile}.dynsym`);
            fs_1.default.unlinkSync(`${outputFile}.dynstr`);
        }
    });
    if (bfdTargetOption) {
