...
const uploadCodeCoverageReport = (request) => (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const event = Object.assign(Object.assign(Object.assign({ type: 'coverage_report', '_dd.hostname': payload.hostname, format: payload.format }, payload.spanTags), payload.customTags), payload.customMeasures);
