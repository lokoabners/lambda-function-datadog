    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.config.apiKey) {
                this.logger.error((0, renderer_1.renderConfigurationError)(new errors_1.InvalidConfigurationError(`Missing ${chalk_1.default.bold('DATADOG_API_KEY')} in your environment`)));
                return 1;
            }
