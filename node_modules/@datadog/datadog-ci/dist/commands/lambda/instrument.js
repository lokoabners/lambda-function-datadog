...
class InstrumentCommand extends clipanion_1.Command {
    ...
    execute() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.sourceCodeIntegration) {
                try {
                    const gitData = yield this.getGitData();
    ...
    getSettings() {
        ...
        const apmFlushDeadline = (_k = this.apmFlushDeadline) !== null && _k !== void 0 ? _k : this.config.apmFlushDeadline;
        const appsecEnabled = (_l = this.appsecEnabled) !== null && _l !== void 0 ? _l : this.config.appsecEnabled;
        const service = (_m = this.service) !== null && _m !== void 0 ? _m : this.config.service;
        const environment = (_o = this.environment) !== null && _o !== void 0 ? _o : this.config.environment;
        const version = (_p = this.version) !== null && _p !== void 0 ? _p : this.config.version;
        const llmobsMlApp = (_q = this.llmobs) !== null && _q !== void 0 ? _q : this.config.llmobs;
        const tagsMap = {
            environment,
            service,
            version,
        ...
        const extraTags = (_s = (_r = this.extraTags) === null || _r === void 0 ? void 0 : _r.toLowerCase()) !== null && _s !== void 0 ? _s : (_t = this.config.extraTags) === null || _t === void 0 ? void 0 : _t.toLowerCase();
        if (extraTags && !(0, commons_1.sentenceMatchesRegEx)(extraTags, constants_2.EXTRA_TAGS_REG_EXP)) {
