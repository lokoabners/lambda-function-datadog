...
const calculateUpdateRequest = (config, runtime) => {
    ...
    const environmentVarsArray = [
        ...
        constants_2.DD_LLMOBS_ENABLED_ENV_VAR,
        constants_2.DD_LLMOBS_ML_APP_ENV_VAR,
        constants_2.DD_LLMOBS_AGENTLESS_ENABLED_ENV_VAR,
    ];
