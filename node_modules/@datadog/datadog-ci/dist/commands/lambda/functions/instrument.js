...
const calculateUpdateRequest = (config, settings, region, runtime) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const environmentVarsTupleArray = [
        ...
        ['extraTags', constants_2.EXTRA_TAGS_ENV_VAR],
        ['mergeXrayTraces', constants_2.MERGE_XRAY_TRACES_ENV_VAR],
        ['service', constants_1.SERVICE_ENV_VAR],
        ['tracingEnabled', constants_2.TRACE_ENABLED_ENV_VAR],
        ['version', constants_1.VERSION_ENV_VAR],
        ['llmobsMlApp', constants_2.DD_LLMOBS_ML_APP_ENV_VAR],
    ];
    ...
    if (newEnvVars[constants_2.LOG_LEVEL_ENV_VAR] !== settings.logLevel) {
        needsUpdate = true;
        if (settings.logLevel) {
            newEnvVars[constants_2.LOG_LEVEL_ENV_VAR] = settings.logLevel;
        }
        else {
            delete newEnvVars[constants_2.LOG_LEVEL_ENV_VAR];
        }
    }
    // Enable ASM
    ...
    if (settings['llmobsMlApp'] !== undefined) {
        newEnvVars[constants_2.DD_LLMOBS_ENABLED_ENV_VAR] = 'true';
        newEnvVars[constants_2.DD_LLMOBS_ML_APP_ENV_VAR] = settings['llmobsMlApp'];
        ...
        newEnvVars[constants_2.DD_LLMOBS_AGENTLESS_ENABLED_ENV_VAR] = 'false';
    }
